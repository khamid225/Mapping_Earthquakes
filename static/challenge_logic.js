...
let apik = 'pk.eyJ1Ijoic2Jhc3NpIiwiYSI6ImNrdDZta3B4MTBqcngyb3I1ZDcybXhqcHIifQ.VUtD-axAe0gBuSWXojsuCA'
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json('/static/js/PB2002_boundaries.json').then(function(plateData) {
		L.geoJson(plateData, {
			            color: "#C5003C",
			            weight: 3
